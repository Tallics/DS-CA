...
public final class Service2Grpc {
  ...
  public static io.grpc.MethodDescriptor<RequestMessage,
      ResponseMessage> getService2DoMethod() {
    io.grpc.MethodDescriptor<RequestMessage, ResponseMessage> getService2DoMethod;
  ...
  public static abstract class Service2ImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void service2Do(RequestMessage request,
  ...
  public static final class Service2BlockingStub extends io.grpc.stub.AbstractStub<Service2BlockingStub> {
    ...
    /**
     */
    public ResponseMessage service2Do(RequestMessage request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SERVICE2_DO:
          serviceImpl.service2Do((RequestMessage) request,
              (io.grpc.stub.StreamObserver<ResponseMessage>) responseObserver);
          break;
        default:
